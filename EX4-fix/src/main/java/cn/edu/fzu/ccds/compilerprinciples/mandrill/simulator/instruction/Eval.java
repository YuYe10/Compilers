...
public class Eval extends Instruction {
    ...
    public void execute(SimulatorMemory vm) {
        ...
        if (op == Constants.EVAL_CONDITION) {
            ...
            long result;
            if (op == Constants.EVAL_ADD)
                result = left + right;
            else if (op == Constants.EVAL_MINUS)
                result = left - right;
            else if (op == Constants.EVAL_MUL)
                result = left * right;
            else if (op == Constants.EVAL_DIV)
                result = left / right;
            else if (op == Constants.EVAL_MOD)
                result = left % right;
            else if (op == Constants.EVAL_GREATER)
                result = left > right ? 1L : 0L;
            else if (op == Constants.EVAL_LESS)
                result = left < right ? 1L : 0L;
            else if (op == Constants.EVAL_GREATER_OR_EQUAL)
                result = left >= right ? 1L : 0L;
            else if (op == Constants.EVAL_LESS_OR_EQUAL)
                result = left <= right ? 1L : 0L;
            else if (op == Constants.EVAL_EQUAL)
                result = left == right ? 1L : 0L;
            else if (op == Constants.EVAL_NOT_EQUAL)
                result = left != right ? 1L : 0L;
            else
