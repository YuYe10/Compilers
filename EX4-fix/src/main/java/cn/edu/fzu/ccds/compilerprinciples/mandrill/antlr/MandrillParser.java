...
public class MandrillParser extends Parser {
	...
	public static final int
		RULE_arraySuffix = 0, RULE_program = 1, RULE_functionDef = 2, RULE_parameterList = 3, 
		RULE_stmtBlock = 4, RULE_statement = 5, RULE_declarationStmt = 6, RULE_jumpStmt = 7, 
		RULE_emptyStmt = 8, RULE_assignStatement = 9, RULE_lvalue = 10, RULE_rvalue = 11, 
		RULE_expression = 12, RULE_argumentList = 13, RULE_loopStatement = 14, 
		RULE_conditionStatement = 15;
	private static String[] makeRuleNames() {
		return new String[] {
			"arraySuffix", "program", "functionDef", "parameterList", "stmtBlock", 
			"statement", "declarationStmt", "jumpStmt", "emptyStmt", "assignStatement", 
			"lvalue", "rvalue", "expression", "argumentList", "loopStatement", "conditionStatement"
		};
	}
	...
	public static class ParameterListContext extends ParserRuleContext {
		public List<TerminalNode> Identifier() { return getTokens(MandrillParser.Identifier); }
		public TerminalNode Identifier(int i) {
			return getToken(MandrillParser.Identifier, i);
		}
	...
	public final EmptyStmtContext emptyStmt() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_emptyStmt);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(103);
