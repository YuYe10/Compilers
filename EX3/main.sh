...
abnormaldir=$(pwd)/mandrill-semantic-error-src
log_file=$(pwd)/$1
make clean
make 
...
score=0
full_score=0
CCHK="java -cp .:../antlr-4.13.2-complete.jar cn.edu.fzu.ccds.compilerprinciples.mandrill.semanticchecker.SemanticCheckerMain"
echo $CCHK
